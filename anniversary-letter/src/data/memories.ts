...
export const memories: Memory[] = [
  {
    ...
    title: '제주도',
    emotion: '시작',
    image: memoryAsset('1-제주도/1-제주도-01.jpg'),
    media: {
      type: 'video',
      src: memoryAsset('1-제주도/1-제주도-01.mp4'),
      poster: memoryAsset('1-제주도/1-제주도-01.jpg'),
    },
    message:
  ...
  },
  {
    ...
    title: '썸',
    emotion: '설렘',
    image: memoryAsset('2-썸/2-썸-02.jpg'),
    media: {
      type: 'image',
      src: memoryAsset('2-썸/2-썸-02.jpg'),
    },
    message:
  ...
  },
  {
    ...
    title: '전역',
    emotion: '축하',
    image: memoryAsset('3-전역/3-전역-01.jpg'),
    media: {
      type: 'image',
      src: memoryAsset('3-전역/3-전역-01.jpg'),
    },
    message:
  ...
  },
  {
    ...
    title: '창원 데이트',
    emotion: '다정함',
    image: memoryAsset('4-창원 데이트/4-창원 데이트-08.jpg'),
    media: {
      type: 'image',
      src: memoryAsset('4-창원 데이트/4-창원 데이트-08.jpg'),
    },
    message:
  ...
  },
  {
    ...
    title: '마산 데이트',
    emotion: '웃음',
    image: memoryAsset('5-마산 데이트/5-마산 데이트-03.jpg'),
    media: {
      type: 'image',
      src: memoryAsset('5-마산 데이트/5-마산 데이트-03.jpg'),
    },
    message:
  ...
  },
  {
    ...
    title: '행궁동 데이트',
    emotion: '산책',
    image: memoryAsset('6-행궁동 데이트/6-행궁동 데이트-03.jpg'),
    media: {
      type: 'image',
      src: memoryAsset('6-행궁동 데이트/6-행궁동 데이트-03.jpg'),
    },
    message:
  ...
  },
  {
    ...
    title: '보정동 데이트',
    emotion: '포근함',
    image: memoryAsset('7-보정동 데이트/7-보정동 데이트-03.jpg'),
    media: {
      type: 'image',
      src: memoryAsset('7-보정동 데이트/7-보정동 데이트-03.jpg'),
    },
    message:
  ...
  },
  {
    ...
    title: '안동 데이트',
    emotion: '여행',
    image: memoryAsset('8-안동 데이트/8-안동 데이트-05.jpg'),
    media: {
      type: 'image',
      src: memoryAsset('8-안동 데이트/8-안동 데이트-05.jpg'),
    },
    message:
  ...
  },
  {
    ...
    title: '부산 데이트',
    emotion: '기념',
    image: memoryAsset('9-부산 데이트/9-부산 데이트-05.jpg'),
    media: {
      type: 'image',
      src: memoryAsset('9-부산 데이트/9-부산 데이트-05.jpg'),
    },
    message:
